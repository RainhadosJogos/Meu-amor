...
const frases = [
  ...
  "Mesmo carregando um Anel, o peso que mais gosto de sentir é o da sua mão na minha.",
  ...
  "Você é a paz que encontro depois de cada batalha.",
...
const diarioMensagens = [
  ...
  "Um Anel pode ser pesado, mas a saudade de você pesa muito mais no meu peito.",
  ...
  "Sinto que desejo mais ele do que o anel.",
...
const playlist = [
  ...
  { title: "Jorge & Mateus - Os Anjos Cantam", id: "ICS6uKC93w0" },
  { title: "Damiano - Zombie Lady", id: "LP2nqXYwl6Q" },
  { title: "Marcos & Belutti  - Sonho De Todo Casal", id: "oejyRpHiP2M" },
  ...
  { title: "Los Tigres Del Norte - La Granja", id: "ff3C-Kyv8wI" },
  { title: "Guns N' Roses - This I Love", id: "vhvP905I-aQ" },
  { title: "Luísa Sonza - Sempre Você ", id: "f_jgCJJRAyY" },
  ...
  { title: "Gustavo Mioto - Princesa", id: "MO37-1KgcI4" },
  { title: "Post Malone ft. Ozzy Osbourne, Travis Scott - Take What You Want", id: "LYa_ReqRlcs" },
  { title: " Fernando & Sorocaba - Deixa Eu Amar Você", id: "NY5-UdFxMnA" },
...
let capsulaAtual = 0;
const memorias = {
  1: "Lembro exatamente de como meu coração disparou quando você me deu aquele bombom de morango do amor, já te queria bem antes disso, um simples pirulito me fez querer te ver todos os dias.",
  2: "A primeira vez que você me disse "Eu te amo" foi a frase mais linda que escutei, no momento não acreditei, porquê achei que eu que falaria primeiro.",
  3: "Nosso primeiro beijo, foi o melhor que já tive, no mesmo instante sabia que você teria que ser meu, porquê você é o amor da minha vida."
};
